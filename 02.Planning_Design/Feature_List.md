...
기능은 시스템 구성도(Architecture.md)의 서비스 구분에 맞추어 6개의 핵심 모듈로 최적화하여 그룹화하였습니다.
...
*   **[CS] 고객지원/커뮤니티 모듈**: 게시판, FAQ, 1:1 문의, 개인정보 동의 이력 (CSSvc 대응)
*   **[ADMIN] 데이터/통계 관리자 모듈**: 모니터링 대시보드, AI 트렌드 통계, 통합 회원·마스터 관리 (AdminSvc 대응)
